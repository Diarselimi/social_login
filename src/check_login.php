...
try {
    if (isset($_SESSION['facebook_access_token'])) {
        ...
        $accessToken = $htok->getAccessToken();
    }
...
if (isset($accessToken)) {
    ...
    try {
        ...
        if ($e->getCode() == 190) {
            ...
            $loginUrl = $helper->getLoginUrl('http://localhost/social_login/src/facebook.php', $permissions);
    ...
    $helper = $fb->getRedirectLoginHelper();
    $loginUrl = $helper->getLoginUrl('http://localhost/social_login/src/facebook.php');
    echo "<script>window.top.location.href='".$loginUrl."'</script>";
}